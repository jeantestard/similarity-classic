...
Classe SokalSnesth calcule la similarité entre deux texte. [Ici classe dérivée de la classe Similarite]

L'indice de Sokal Snesth dérive de l'indice Sokal et Michener. Il inscrit les résultats dans l'intervalle [0,1]
et accorde deux fois plus de poids aux concordances qu'aux différences.
...
#Calcul de similarité selon Sockal et Sneath : 2a / 2a + b + c
